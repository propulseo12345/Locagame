-- ══════════════════════════════════════════════════════════════════════════════
-- Migration: Bloquer les réservations de produits à 0€ (tarif sur devis)
-- Date: 2026-03-25
--
-- Problème: Un produit actif avec pricing.oneDay = 0 ou NULL pourrait être
--           réservé gratuitement via la RPC validate_and_create_reservation.
--           Le frontend grise déjà le bouton mais aucune garde serveur n'existait.
--
-- Solution: Ajouter un contrôle après le calcul de v_unit_price (section 3b)
--           qui rejette les produits sans prix valide.
-- ══════════════════════════════════════════════════════════════════════════════
