-- ============================================================
-- Migration: Nettoyage des delivery_tasks à l'expiration
-- Supprime les delivery_tasks orphelines quand une réservation expire
-- Filet de sécurité pour les tasks créées avant le fix
-- ============================================================
...
BEGIN
  ...
  -- Supprimer les delivery_tasks orphelines
