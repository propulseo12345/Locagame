...
import type { CheckoutPayload, CheckoutResult } from './checkoutTypes';

// Re-export types for backward compatibility
export type { CheckoutPayload, CheckoutResult } from './checkoutTypes';
...
export class CheckoutService {
  ...
  static async createAuthenticatedCheckout(
    ...
    try {
      // 0. SECURITE: Vérifier la disponibilité de TOUS les produits AVANT toute opération
