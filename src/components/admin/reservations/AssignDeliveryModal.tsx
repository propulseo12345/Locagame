...
export default function AssignDeliveryModal({
  ...
  return (
    <div ref={containerRef} role="dialog" aria-modal="true" aria-labelledby="assign-delivery-title" className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
