    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl md:text-2xl font-bold text-gray-900">{monthStats.total}</p>
      ...
      <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl md:text-2xl font-bold text-gray-900">{monthStats.deliveries}</p>
      ...
      <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl md:text-2xl font-bold text-gray-900">{monthStats.pickups}</p>
      ...
      <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl md:text-2xl font-bold text-gray-900">{monthStats.completionRate}%</p>
